...
export const routerObj: RouterObj = {
    ...
    '/editBanner': { title: '添加图片', key: '' },
    '/editBannerSearch': { title: '编辑图片', key: '' },
    '/login': { title: '登录', key: '' },
}
